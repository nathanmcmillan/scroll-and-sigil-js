...
export class PaintState {
  ...
  render() {
    ...
    drawTextSpecial(client.bufferGUI, 10, 10 + fontHeight * 2, displaySize, fontScale, white0, white1, white2, 1.0)
    ...
    // drawTextSpecial(client.bufferGUI, canvasWidth - width, canvasHeight - topBarHeight + pad, topBarSwitch, fontScale, darkpurplef(0), darkpurplef(1), darkpurplef(2), 1.0)
