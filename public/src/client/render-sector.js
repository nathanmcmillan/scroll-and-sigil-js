...
export function drawReferenceWall(b, wall) {
  let pos = b.vertexPosition
  let vertices = b.vertices

  let line = wall.line

  let x = line.a.y - line.b.y
  let y = -(line.a.x - line.b.x)
  let magnitude = Math.sqrt(x * x + y * y)
  x /= magnitude
  y /= magnitude

  vertices[pos] = line.a.x
  vertices[pos + 1] = wall.ceiling
  vertices[pos + 2] = line.a.y
  vertices[pos + 3] = wall.u
  vertices[pos + 4] = wall.t
  vertices[pos + 5] = x
  vertices[pos + 6] = 0.0
  ...
  vertices[pos + 8] = line.a.x
  vertices[pos + 9] = wall.floor
  vertices[pos + 10] = line.a.y
  vertices[pos + 11] = wall.u
  vertices[pos + 12] = wall.v
  vertices[pos + 13] = x
  vertices[pos + 14] = 0.0
  ...
  vertices[pos + 16] = line.b.x
  vertices[pos + 17] = wall.floor
  vertices[pos + 18] = line.b.y
  vertices[pos + 19] = wall.s
  vertices[pos + 20] = wall.v
  vertices[pos + 21] = x
  vertices[pos + 22] = 0.0
  ...
  vertices[pos + 24] = line.b.x
  vertices[pos + 25] = wall.ceiling
  vertices[pos + 26] = line.b.y
  vertices[pos + 27] = wall.s
  vertices[pos + 28] = wall.t
  vertices[pos + 29] = x
  vertices[pos + 30] = 0.0
